...
func setupRoutes(r *gin.Engine) {
    ...
    // Your existing CORS test endpoint
    ...
    // Your existing public auth routes
    authRoutes := r.Group("/")
    ...
    // Your existing admin routes with PDF routes added
    admin := r.Group("/admin")
    ...
    // Your existing user routes with PDF upload capability
    user := r.Group("/user")
    ...
    // analysis.Use(handlers.RateLimitMiddleware("general"))
    // {
    //     analysis.GET("/chats", handlers.GetAllChatAnalysis)
    //     analysis.GET("/project/:id", handlers.GetProjectChatAnalysis)
    //     analysis.GET("/status", handlers.GetProcessingStatus)
    // }
